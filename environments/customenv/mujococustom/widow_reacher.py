...
class WidowReacher(MujocoEnv, utils.EzPickle):
    """
    ## Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, **kwargs):
        ...
        self.initial_goal = np.array([0.0, 0.3, 0.3])
...
gymnasium.register("Widow", "environments.customenv.mujococustom.widow_reacher:WidowReacher")
