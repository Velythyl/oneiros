...
class RMA(_Alg):
    ...
    def train(self):
        ...
        for update in range(1, num_updates + 1):
            ...
            logger.log(self.merge_logs(wandb_logs, global_step + self.phase_1_steps_done))  # adds up the last phase's steps
        ...
        if self.agent.phase == 1:
            ...
            self.phase_1_steps_done = global_step
            return self.train()
        elif self.agent.phase == 2:
            print("PHASE 2 DONE.")
            return
